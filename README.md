...
![Base name tag picture not found!](https://github.com/brennansaul/nameTag/blob/master/Basenametagbox.png "In order to have a consistent base display I created this image first and then created duplicates that I added information too. I also used this image so that I styled canvas for displaying system information such as date and time.")
